...
void main(){
  ...
  gl_FragColor = vec4(newv, 0.0, 0.0);
    ...
    class MouseClass {
      ...
      dispose() {
        if (this.listenerTarget && this._onMouseMove && this._onTouchStart && this._onTouchMove && this._onTouchEnd) {
    ...
    // Continue with shader passes and simulation classes...
    ...
    class Advection extends ShaderPass {
      ...
      updateParams({ dt, isBounce, BFECC }: any) {
    ...
    // Continue with Simulation and Output classes...
